  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <h1 className="text-5xl font-bold text-navy mb-8">Политика конфиденциальности</h1>
        
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">1. Общие положения</h2>
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">2. Собираемая информация</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">3. Цели обработки данных</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">4. Защита данных</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">5. Передача данных третьим лицам</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">6. Ваши права</h2>
            <p className="leading-relaxed">
              Вы имеете право:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">7. Контактная информация</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-bold text-navy mb-4">8. Изменения в Политике</h2>
            <p className="leading-relaxed">
